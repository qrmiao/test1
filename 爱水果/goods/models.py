...
class TypeInfo(models.Model):
    ...
    pic = models.ImageField(u'图片', upload_to='df_goods')
    # 商品类型对象返回名字
    # def __str__(self):
...
class GoodsInfo(models.Model):
    ...
    isre = models.BooleanField(default=False)
    isxin = models.BooleanField(default=False)
    isjin = models.BooleanField(default=False)
